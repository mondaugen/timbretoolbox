function fcoefs=MakeERBCoeffs(fs,cfArray,Bfactor)
% fcoefs=MakeERBCoeffs(fs,cfArray,Bfactor)
%
% fs: (Hz) sampling frequency
% cfArray: (Hz) filter CFs (default is 25 values spaced 100 to fs/4)
% BFactor: bandwidth factor (default=1)
% fcoefs: coefficients used by ERBFilterBank()
%
...
%
% The filter bank contains channels with characteristic frequencies
% defined in cfArray.
%
% See also ERBspace, MakeERBFilters.
